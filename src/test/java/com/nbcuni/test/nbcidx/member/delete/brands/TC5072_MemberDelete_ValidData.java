...
/*****************************************************************************
 * NBCIDX Member.Delete API - TC5072_MemberDelete_ValidData. Copyright. 
 * 
 * @author Rashmi Sale
 * @version 1.0 Date: Sep 11, 2014
 *****************************************************************************/

public class TC5072_MemberDelete_ValidData {
     ...
     */
	@Test(groups = {"full"})
	public void memberDelete_ValidData() throws Exception {
				
		Reporter.log("Validating member.delete with valid data");
		Reporter.log("");
