...
/**************************************************************************
 * NBCIDX Member.Delete API - TC5079_MemberDelete_Error_400. Copyright. 
 * 
 * @author Rashmi Sale
 * @version 1.0 Date: Sep 11, 2014
 **************************************************************************/

public class TC5079_MemberDelete_Error_400 {
     ...
     */
	@Test(groups = {"full"})
	public void memberDelete_error400() throws Exception {
		...
		Reporter.log("4) Member.delete with paramater 'i'");
		Reporter.log("");
		myJsonBody ="i="+uuid;
