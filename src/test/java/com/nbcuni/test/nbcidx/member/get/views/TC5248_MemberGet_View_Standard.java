...
/**************************************************************************
 * NBCIDX Member.Get API - TC5248_MemberGet_View_Standard. Copyright. 
 * 
 * @author Rashmi Sale
 * @version 1.0 Date: July 4, 2014
 **************************************************************************/

public class TC5248_MemberGet_View_Standard {
	...
	*/
     ...
     */
	@Test(groups = {"full"})
	public void memberGet_view_standard() throws Exception {
		...
		Reporter.log("1) Verifying member.get API Response with view=standard and id=username");
		params = "view=standard&id="+name;
		...
		Reporter.log("2) Validating member.get API Response with view=standard and id=UUID");
		params = "view=standard&id="+uuid;
