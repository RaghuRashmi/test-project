...
/**************************************************************************
 * NBCIDX Member.Get API - TC5249_MemberGet_View_UserEntered. Copyright. 
 * 
 * @author Rashmi Sale
 * @version 1.0 Date: July 4, 2014
 **************************************************************************/

public class TC5249_MemberGet_View_UserEntered {
	...
	*/
     ...
     */
	@Test(groups = {"full"})
	public void memberGet_view_userEntered() throws Exception {
		...
		Reporter.log("1) Validating member.get API Response with view=user-entered and id=username");
		params = "view=user-entered&id="+name;
		...
		Reporter.log("2) Validating member.get API Response with view=user-entered and id=UUID");
		params = "";
		params = "view=user-entered&id="+uuid;
