...
/**************************************************************************
 * NBCIDX Member.Get API - TC5251_MemberGet_View_AdTargeting. Copyright. 
 * 
 * @author Rashmi Sale
 * @version 1.0 Date: July 4, 2014
 **************************************************************************/

public class TC5251_MemberGet_View_AdTargeting {
     ...
     */
	@Test(groups = {"full"})
	public void memberGet_view_adTargeting() throws Exception {
		...
		Reporter.log("1) Validating member.get API Response with view=ad-targeting and id=username");
		params = "view=ad-targeting&id="+name;
		...
		Reporter.log("2) Validating member.get API Response with view=ad-targeting and id=UUID");
		params = "";
		params = "view=ad-targeting&id="+uuid;
