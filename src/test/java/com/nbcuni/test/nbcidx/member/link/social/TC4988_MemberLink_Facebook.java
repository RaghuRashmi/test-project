...
/**************************************************************************
 * NBCIDX Member.Link API - TC4988_MemberLink_Facebook. Copyright. 
 * 
 * @author Rashmi Sale
 * @version 1.0 Date: Sep 10, 2014
 **************************************************************************/

public class TC4988_MemberLink_Facebook {
	...
	@Test(groups = {"full"})
	public void memberLink_Facebook() throws Exception {
        ...
        if(count>4 && mylink!=200)
        	fail("Linking with Facebook is Not successful");
