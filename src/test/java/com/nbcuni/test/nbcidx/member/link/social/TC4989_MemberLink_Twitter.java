...
/**************************************************************************
 * NBCIDX Member.Link API - TC4989_MemberLink_Twitter. Copyright. 
 * 
 * @author Rashmi Sale
 * @version 1.0 Date: Sep 10, 2014
 **************************************************************************/

public class TC4989_MemberLink_Twitter {
	...
	@Test(groups = {"full"})
	public void memberLink_Twitter() throws Exception {
        ...
        if(count>4 && mylink!=200)
        	fail("Linking with Twitter is Not successful");
		...
		if (mylink==200)
			...
			Reporter.log("Unlinking with Twitter is Not successful");
	}
}
