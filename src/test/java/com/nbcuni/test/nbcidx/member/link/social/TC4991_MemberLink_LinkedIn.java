...
/**************************************************************************
 * NBCIDX Member.Link API - TC4991_MemberLink_LinkedIn. Copyright. 
 * 
 * @author Rashmi Sale
 * @version 1.0 Date: Sep 10, 2014
 **************************************************************************/

public class TC4991_MemberLink_LinkedIn {
	...
	@Test(groups = {"full"})
	public void memberLink_LinkedIn() throws Exception {
        ...
        if(count>4 && mylink!=200)
        	fail("Linking with LinkedIn is Not successful");
		...
		if (mylink==200)
			...
			Reporter.log("Unlinking with Linkedin is Not successful");			
	}
}
