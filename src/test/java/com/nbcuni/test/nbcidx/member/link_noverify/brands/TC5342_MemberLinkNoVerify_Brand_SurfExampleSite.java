...
/***********************************************************************************************
 * NBCIDX Member.Link_noverify API - TC5342_MemberLinkNoVerify_Brand_SurfExampleSite. Copyright. 
 * 
 * @author Rashmi Sale
 * @version 1.0 Date: Sep 10, 2014
 **********************************************************************************************/

public class TC5342_MemberLinkNoVerify_Brand_SurfExampleSite {
	...
	@Test(groups = {"full"})
	public void memberLinkNoVerify_SurfExampleSite() throws Exception {
		
		Reporter.log("Validating member.link_noverify with brand = Surf Example Site");
		Reporter.log(" ");
		...
		Reporter.log("5) Removing member from brand = Surf Example Site");
		//Generate Post Body.
		postBody = "id="+uuid;
