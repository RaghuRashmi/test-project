...
/**********************************************************************************************
 * NBCIDX Member.Link_noverify API - TC5344_MemberLinkNoVerify_Brand_INTERNALf645. Copyright. 
 * 
 * @author Rashmi Sale
 * @version 1.0 Date: Sep 10, 2014
 **********************************************************************************************/

public class TC5344_MemberLinkNoVerify_Brand_INTERNALf645 {
	...
	public void memberLinkNoVerify_INTERNALf645() throws Exception {
		
		Reporter.log("Validating member.link_noverify with brand = INTERNAL f645");
		Reporter.log(" ");
		...
		Reporter.log("5) Removing member from brand = INTERNAL f645");
		//Generate Post Body.
		postBody = "id="+uuid;
