...
/*******************************************************************************************
 * NBCIDX Member.Link_noverify API - TC5345_MemberLinkNoVerify_Brand_INTERNALc1ab. Copyright. 
 * 
 * @author Rashmi Sale
 * @version 1.0 Date: Sep 10, 2014
 *******************************************************************************************/

public class TC5345_MemberLinkNoVerify_Brand_INTERNALc1ab {
	...
	public void memberLinkNoVerify_INTERNALc1ab() throws Exception {
		
		Reporter.log("Validating member.link_noverify with brand = INTERNAL c1ab");
		Reporter.log(" ");
		...
		Reporter.log("5) Removing member from brand = INTERNAL c1ab");
		//Generate Post Body.
		postBody = "id="+uuid;
