...
public class TC5347_MemberLinkNoVerify_Brand_INTERNALb7b4 {
	...
	public void memberLinkNoVerify_INTERNALb7b4() throws Exception {
		
		Reporter.log("Validating member.link_noverify with brand = INTERNAL b7b4");
		Reporter.log(" ");
		...
		Reporter.log("5) Removing member from brand = INTERNAL b7b4");
		//Generate Post Body.
		postBody = "id="+uuid;
