package com.nbcuni.test.nbcidx.member.login.autoArchiveHistory;

import static org.testng.AssertJUnit.fail;

/********************************************************************************
 * NBCIDX Member.Login API - TC4168_Auto_Archive_History_Verification. Copyright. 
 * 
 * @author Rashmi Sale
 * @version 1.0 Date: Aug 22, 2014
 ********************************************************************************/
...
public class TC4168_Auto_Archive_History_Verification {
	...
	public void verifyHistoryCollection() throws Exception {
		...
		// Log-in and log-out the member for multiple times and check if login data is getting auto archived each time in idx_metadata_history collection of MongoDB?		
