...
/**************************************************************************
 * NBCIDX Member.Login API - TC3375_MemberLogin_DirectLogin_UUID. Copyright. 
 * 
 * @author Rashmi Sale
 * @version 1.0 Date: June 16, 2014
 **************************************************************************/

public class TC3375_MemberLogin_DirectLogin_UUID {
     ...
     */
	@Test(groups = {"full"})
	public void memberLogin_uuid() throws Exception {
		...
		// 4) member.logout with uuid
		Reporter.log("4) member.logout with the uuid of a member");
		jsonBody ="id="+uuid;
		JsonObject mylogout = ma.memberLOGOUTResponse(api, al, jsonBody, surfBrandId, randomMemberName, mydb);
		if(mylogout ==null)
			fail("Error/Null Response from API call");
		Reporter.log("-- X --");
		Reporter.log("");		
