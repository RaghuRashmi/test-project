...
/**************************************************************************
 * NBCIDX Member.Login API - TC3374_MemberLogin_Error_502. Copyright. 
 * 
 * @author Rashmi Sale
 * @version 1.0 Date: June 16, 2014
 **************************************************************************/

public class TC3374_MemberLogin_Error_502 {
	...
	public void memberLogin_error502() throws Exception {
		...
		String apicall =  al.getApiURL()+"/member/login?API_KEY=65432165432165432165432165432165&BRAND_ID=fffff99b56d8d0567d3465876e8579c2";
		
		Reporter.log("");
		Reporter.log("1) Member.login with 'Delay 6' Brand");
