...
/*****************************************************************************
 * NBCIDX Member.Put API - TC4931_MemberRemove_IDXAPIExplorer. Copyright. 
 * 
 * @author Rashmi Sale
 * @version 1.0 Date: July 4, 2014
 *****************************************************************************/

public class TC4570_MemberPut_Brand_IDXAPIExplorer {
     ...
     */
	@Test(groups = {"full"})
	public void memberPut_IDXAPIExplorer() throws Exception {
				
		Reporter.log("1) Validating member.put with brand = IDX API Explorer");
