...
/*****************************************************************************
 * NBCIDX Member.Put API - TC5075_MemberDelete_Brand_INTERNALf645. Copyright. 
...
public class TC4571_MemberPut_Brand_INTERNALf645 {
	...
	public void memberPut_INTERNALf645() throws Exception {
				
		Reporter.log("1) Validating member.put with brand = INTERNAL f645");
		...
		jsonBody = "";
		jsonBody ="{'_id': '"+sApiUUID+"','suffix': 'MS','phone': [{'mobile': true,'number': '8884444333'}],'prefix': 'Dr.','brand_data': {'MyChoice': 'INTERNAL f645'},'address': [{'address1': '1070 Morris Ave','address2': 'Apt # 1254','city': 'Union','state': 'NJ','postalcode': '07083','country': 'US','primary': true,'type': 'home'}],'avatar': 'http://www.mbc.com/','screenname': 'Master'}";
		...
		bMemberBrandData = brandDataArrlst.get(0).toString().contains("MyChoice:INTERNAL f645");
		Reporter.log(brandDataArrlst.get(0).toString());
		Assert.assertEquals(bMemberBrandData, true);
		...
		Reporter.log("7) Removing the member from IDX INTERNALf645 brand");
