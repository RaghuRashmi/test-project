...
/*****************************************************************************
 * NBCIDX Member.Put API - TC5077_MemberDelete_Brand_INTERNALb92e. Copyright. 
...
public class TC4573_MemberPut_Brand_INTERNALb92e {
	...
	public void memberPut_INTERNALb92e() throws Exception {
				
		Reporter.log("1) Validating member.put with brand = INTERNAL b92e");
		...
		Reporter.log("7) Removing the member from IDX INTERNALb92e brand");
