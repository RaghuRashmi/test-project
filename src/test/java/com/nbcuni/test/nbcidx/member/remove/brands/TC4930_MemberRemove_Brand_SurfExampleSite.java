...
/**********************************************************************************
 * NBCIDX Member.Remove API - TC4930_MemberRemove_Brand_SurfExampleSite. Copyright. 
 * 
 * @author Rashmi Sale
 * @version 1.0 Date: Aug 31, 2014
 *********************************************************************************/

public class TC4930_MemberRemove_Brand_SurfExampleSite {
     ...
     */
	@Test(groups = {"full"})
	public void memberRemove_SurfExampleSite() throws Exception {
				
		Reporter.log("1) Creating member with brand = Surf Example Site");
		Reporter.log("");
		...
		searchQuery.put("metadata.username.brand_id",surfBrandId);
		...
		Reporter.log("");
		Reporter.log("2) Removing the member from brand Surf Example Site");
