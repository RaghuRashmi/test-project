...
/*****************************************************************************
 * NBCIDX Member.Remove API - TC5271_MemberRemove_Brand_INTERNALf645. Copyright. 
...
public class TC5271_MemberRemove_Brand_INTERNALf645 {
	...
	public void memberRemove_INTERNALf645() throws Exception {
				
		Reporter.log("Validating member.put with brand = INTERNAL f645");
		Reporter.log("");
		Reporter.log("1) Creating member using member.put in brand = INTERNAL f645");
		...
		Reporter.log("2) Removing the member from IDX INTERNALf645 brand using member.remove");
