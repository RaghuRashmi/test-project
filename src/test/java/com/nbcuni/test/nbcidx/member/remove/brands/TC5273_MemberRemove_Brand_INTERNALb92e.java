...
/*******************************************************************************
 * NBCIDX Member.Delete API - TC5273_MemberRemove_Brand_INTERNALb92e. Copyright. 
...
public class TC5273_MemberRemove_Brand_INTERNALb92e {
	...
	public void memberRemove_INTERNALb92e() throws Exception {
				
		Reporter.log("Validating member.put with brand = INTERNAL b92e");
		Reporter.log("");
		Reporter.log("1) Creating member using member.put in brand = INTERNAL b92e");
		...
		Reporter.log("2) Removing the member from IDX INTERNALb92e brand using member.remove");
