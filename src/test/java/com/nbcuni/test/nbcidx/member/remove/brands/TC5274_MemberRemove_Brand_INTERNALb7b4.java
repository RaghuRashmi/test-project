...
/*******************************************************************************
 * NBCIDX Member.Delete API - TC5274_MemberRemove_Brand_INTERNALb7b4. Copyright. 
...
public class TC5274_MemberRemove_Brand_INTERNALb7b4 {
	...
	public void memberRemove_INTERNALb7b4() throws Exception {
				
		Reporter.log("Validating member.put with brand = INTERNAL b7b4");
		Reporter.log("");
		Reporter.log("1) Creating member using member.put in brand = INTERNAL b7b4");
		...
		Reporter.log("2) Removing the member from IDX INTERNALb7b4 brand using member.remove");
