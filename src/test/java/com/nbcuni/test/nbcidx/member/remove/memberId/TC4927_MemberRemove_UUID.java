...
/**************************************************************************
 * NBCIDX Member.Remove API - TC4927_MemberRemove_UUID. Copyright. 
 * 
 * @author Rashmi Sale
 * @version 1.0 Date: Aug 31, 2014
 **************************************************************************/

public class TC4927_MemberRemove_UUID {
     ...
     */
	@Test(groups = {"full"})
	public void memberRemove_uuid() throws Exception {
		...
		Reporter.log("3) member.remove with uuid to remove member from IDX");
		jsonBody = "id="+uuid;
