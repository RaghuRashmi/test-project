...
/**************************************************************************
 * NBCIDX Member.Remove API - TC4928_MemberRemove_Email. Copyright. 
 * 
 * @author Rashmi Sale
 * @version 1.0 Date: Aug 31, 2014
 **************************************************************************/

public class TC4928_MemberRemove_Email {
     ...
     */
	@Test(groups = {"full"})
	public void memberRemove_email() throws Exception {
		...
		// 3) member.remove with email 
		Reporter.log("3) member.remove with email to remove member from IDX");
		jsonBody = "id="+randomEmail;
