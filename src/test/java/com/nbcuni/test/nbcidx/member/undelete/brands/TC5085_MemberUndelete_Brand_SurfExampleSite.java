...
/**************************************************************************************
 * NBCIDX Member.Undelete API - TC5085_MemberUndelete_Brand_SurfExampleSite. Copyright. 
 * 
 * @author Rashmi Sale
 * @version 1.0 Date: Sep 12, 2014
 *************************************************************************************/

public class TC5085_MemberUndelete_Brand_SurfExampleSite {
     ...
     */
	@Test(groups = {"full1"})
	public void memberUndelete_SurfExampleSite() throws Exception {
				
		Reporter.log("Validating member.put with brand = Surf Example Site");
