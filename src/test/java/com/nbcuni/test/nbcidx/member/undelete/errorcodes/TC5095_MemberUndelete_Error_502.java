...
public class TC5095_MemberUndelete_Error_502 {
	...
	public void memberUndelete_error502() throws Exception {
		...
		String apicall =  al.getApiURL()+"/member/undelete?API_KEY=65432165432165432165432165432165&BRAND_ID=fffff99b56d8d0567d3465876e8579c2";
		
		Reporter.log("");
		Reporter.log("1) Member.undelete with 'Delay 6' Brand");
