...
public class SC02_TC01_MemberPut_API_Verification {
	...
	public void memberPut_verifyAPI() throws Exception {
		...
		String pw=SC01_Create_RandomMemberInfo.randomPassword;
		String email=SC01_Create_RandomMemberInfo.randomEmail;
						
		// Generate the JSON Body for POST 
		String myJsonBody ="{\"username\":\""+name+"\",\"password\":\""+pw+"\",\"email\":\""+email+"\"}";
	
		// Send member.put POST Request 
		JsonObject response= ma.memberPUT(al, myJsonBody, proxy);
