...
/****************************************************************************
 * NBCIDX Sanity Test Cases - SC02_TC02_MemberPut_DB_Verification. Copyright. 
 * 
 * @author Rashmi Sale
 * @version 1.0 Date: Feb 7, 2014
 ****************************************************************************/

public class SC02_TC02_MemberPut_DB_Verification {
	...
	public void memberPut_verifyDB() throws Exception {
		...
		boolean bMembername = dbresponse.contains(name);
		Assert.assertEquals(bMembername, true);
			
		boolean bEmail = dbresponse.contains(email);
