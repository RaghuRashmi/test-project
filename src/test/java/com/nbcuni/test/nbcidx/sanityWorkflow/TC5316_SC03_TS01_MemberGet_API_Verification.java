...
public class TC5316_SC03_TS01_MemberGet_API_Verification {
	...
	public void memberGet_verifyAPI() throws Exception {
		...
		Reporter.log("a) Validating member.get API Response Code");
		...
		Reporter.log("b) Validating member.get API Response");
